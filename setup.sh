...
echo -e "${YELLOW}What was the email address your created for the GPG key?${NC}"
read email
sudo -u www-data sh -c "gpg --homedir /var/www/MISP/.gnupg --export --armor $email > /var/www/MISP/app/webroot/gpg.asc"
